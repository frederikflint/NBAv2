...
def extract_team_statistics(team, conference_index):
    try:
...
try:
    for team in eastern_teams:
        eastern_standings[team] = extract_team_statistics(team, 1)
...
try:
    for team in western_teams:
        western_standings[team] = extract_team_statistics(team, 3)
